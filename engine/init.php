...
if( $config['allow_redirects'] ) {
	...
	if(isset($redirects['simple']) AND is_array($redirects['simple']) AND count($redirects['simple']) AND $redirects['simple'][$uri] AND !isset($_SESSION['is_redirect'])  ) {
	...
	if(isset($redirects['regex']) AND  is_array($redirects['regex']) AND count($redirects['regex']) AND !isset($_SESSION['is_redirect'])  ) {	
