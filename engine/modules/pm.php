...
if( isset( $_POST['send'] ) and !$stop_pm ) {
	...
	if( !$_SESSION['duplicateprotection'] OR $_POST['duplicateprotection'] != $_SESSION['duplicateprotection'] ) {
...
if( $doaction == "del" AND !$stop_pm AND isset($_GET['pmid']) ) {
	...
	$_SESSION['duplicateprotection'] = md5(SECURE_AUTH_KEY.time());
