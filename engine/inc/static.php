...
HTML;
	...
	msg( "success", $lang['static_addok'], $lang['static_addok_1'], array('?mod=static&action=addnew' => $lang['add_s_1'], '?mod=static&action=doedit&id='.$row => $lang['add_s_2'], $_SESSION['static_referrer'] => $lang['add_s_3'], $full_link => $lang['add_s_5'] ) );
...
HTML;
	...
	$tpl = $db->safesql(cleanpath( $_POST['static_tpl'] ));
	$skin_name =  isset( $_POST['skin_name'] ) ? trim( totranslit( $_POST['skin_name'], false, false ) ) : '';
	...
	if( isset($_GET['page']) AND $_GET['page'] == "rules" ) {
		...
		msg( "success", $lang['rules_ok'], $lang['rules_ok'], array( '?mod=static&action=doedit&page=rules' => $lang['add_s_4'], $full_link => $lang['add_s_5'] )  );
		...
		msg( "success", $lang['static_addok'], $lang['static_addok_1'], array( $_SESSION['static_referrer'] => $lang['add_s_3'], '?mod=static&action=doedit&id='.$id => $lang['add_s_4'], $full_link => $lang['add_s_5'] ) );
