...
if( $action == "del" ) {
	...
	$allow_public_file_upload = intval( $_REQUEST['allow_public_file_upload'] );
	...
	if( $user_group[$id]['allow_public_file_upload'] ) $allow_public_file_upload = "checked";
