...
class ParseFilter {
	...
	function clear_url($url) {
		...
		if ( $url_array['scheme'] AND !in_array( $url_array['scheme'], array("http","https","mailto","ftp","nntp","news","tel","magnet","viber","tg","skype","market")) ) {
	...
	function fix_p_in_div ( $matches=array() ) {
		if(stripos( $matches[2], "<div" ) !== false ) {
